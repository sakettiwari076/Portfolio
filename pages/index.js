...
export default function Home() {
  return (
    <div>
    <nav className="bg-black py-5 border-gray-200 px-2 sm:px-4 text-2xl  rounded dark:bg-gray-800">
    ...
    <div className='container px-2 pt-2 text-white w-3/4'>
        <div className='flex justify-center py-52'>
          <p className='text-4xl tracking-wide	'>HI THERE , I 'M <h1 className='text-8xl font-bold
          '>saket tiwari</h1> </p> 
