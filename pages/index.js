...
export default function Home() {
  ...
  <div>
    ...
    <div className='container px-2 pt-2 text-white '>
       ...
       <button class="h-10 rounded-full  px-20 m-2 pt text-black text-xl font-mono font-extrabold  transition-colors duration-150 bg-green-500  focus:shadow-outline hover:bg-green-800">Contact me</button>
