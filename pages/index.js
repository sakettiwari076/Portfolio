  ...
  <div>
    ...
    <div className='container px-2 pt-2 text-white '>
        ...
        <div className='flex justify-center pt-64 ml-72 '>
          <p className='text-4xl tracking-wide font-mono  	'>HI THERE , I 'M  <h1 className='text-9xl font-bold line-1 anim-typewriter
      ...
      <a href='/contactme'><button className="h-10 rounded-full  px-20 m-2 pt text-black text-xl font-mono font-extrabold  transition-colors duration-150 bg-green-500  focus:shadow-outline hover:bg-green-800">Contact me</button></a>
